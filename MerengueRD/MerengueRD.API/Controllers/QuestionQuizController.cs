...
namespace MerengueRD.API.Controllers
{
    ...
    public class QuestionQuizController(EventChronologicalService eventService) : ControllerBase
    {
        private readonly EventChronologicalService _eventService = eventService;
